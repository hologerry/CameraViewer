...
from src.loader import load_colmap, load_nerf, load_quick
...
fig = viz.update_figure(
    args.scene_size, base_radius=1, zoom_scale=1, show_grid=True, show_ticklabels=True, show_background=True
)
